...
function rutGetLookupData(e, t) {
	...
	var n = location.hostname.indexOf("rclgroup") >= 0 ? "http://" + location.hostname + r + "/HLPWSWebApp/rclws/help/genericHelp" : "http://zebra-ce.rclgroup.com/HLPWSWebApp/rclws/help/genericHelp",
		l = e.processor;
