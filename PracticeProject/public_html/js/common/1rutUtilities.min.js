...
function rutGetLookupData(e, t) {
    ...
    var n = location.hostname.indexOf("rclgroup") >= 0 ? "http://" + location.hostname + "/HLPWSWebApp/rclws/help/genericHelp" : "http://marlin-ce9.rclgroup.com/HLPWSWebApp/rclws/help/genericHelp",
        l = e.processor;
